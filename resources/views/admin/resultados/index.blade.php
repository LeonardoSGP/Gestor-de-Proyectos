        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow mb-6 flex items-center gap-4">
                ...
                <form action="{{ route('admin.resultados.index') }}" method="GET">
                    <select name="evento_id" onchange="this.form.submit()" class="border-gray-300 dark:bg-gray-900 dark:border-gray-600 dark:text-gray-300 rounded-md text-sm">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                    ...
                    @if ($ranking->isEmpty())
                        <p class="text-gray-500 dark:text-gray-400 italic">No hay datos suficientes para calcular resultados en este
                            evento.</p>
                    @else
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                @foreach ($ranking as $index => $item)
                                    ...
                                    @endphp
                                    <tr class="{{ $filaClass }}">
                                        <td class="px-6 py-4 whitespace-nowrap text-xl font-bold text-gray-800 dark:text-gray-200">
                                            {{ $medalla }}
                                        </td>
                                        <td
