                ...
                <form method="POST" action="{{ route('admin.eventos.update', $evento) }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <x-text-input id="fecha_inicio" class="block mt-1 w-full" type="datetime-local" name="fecha_inicio" :value="old('fecha_inicio', $evento->fecha_inicio)" required />
                            <x-input-error :messages="$errors->get('fecha_inicio')" class="mt-2" />
                        </div>

                        <div>
                            <x-input-label for="fecha_fin" :value="__('Fecha de Fin')" />
                            <x-text-input id="fecha_fin" class="block mt-1 w-full" type="datetime-local" name="fecha_fin" :value="old('fecha_fin', $evento->fecha_fin)" required />
