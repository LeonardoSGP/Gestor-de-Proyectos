<x-app-layout>
    <div class="mx-auto max-w-270">
        ...
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <h2 class="text-title-md2 font-bold text-black dark:text-white text-2xl">Editar Carrera</h2>
            <nav>
        ...
        <div class="rounded-xl border border-gray-200 bg-white shadow-default dark:border-gray-700 dark:bg-gray-800">
            <div class="border-b border-gray-200 py-4 px-6.5 dark:border-gray-700">
                <h3 class="font-semibold text-gray-900 dark:text-white">Actualizar Datos</h3>
            </div>
                ...
                <div class="p-6.5">
                    ...
                    <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                        <div class="w-full xl:w-1/3">
                            ...
                            <input type="text" name="clave" value="{{ old('clave', $carrera->clave) }}" required
