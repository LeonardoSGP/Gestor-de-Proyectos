        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6 border-l-4 border-indigo-500">
                    ...
                    <div class="text-2xl font-bold text-gray-800 dark:text-gray-100">{{ $total_jueces + $total_participantes }}</div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6 border-l-4 border-purple-500">
                    ...
                    <div class="text-2xl font-bold text-gray-800 dark:text-gray-100">{{ $eventos_activos->count() }}</div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        {{-- Gráfico 1: Carreras --}}
                        <div>
                            <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2 text-center">Participación por Carrera</h4>
                        ...
                        <div>
                            <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2 text-center">Progreso de Evaluación</h4>
                            <div class="relative h-48">
                ...
                <div class="lg:col-span-1 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    @else
                        <div class="space-y-4">
                            @foreach($eventos_activos as $evento)
                                <div class="flex items-start space-x-3 p-3 bg-indigo-50 dark:bg-gray-900 rounded-lg border border-indigo-100 dark:border-gray-700">
                                    <div class="bg-white dark:bg-gray-800 p-2 rounded text-center border border-indigo-200 dark:border-gray-600 min-w-[50px]">
                                    ...
                                    <div>
                                        <h4 class="text-sm font-bold text-indigo-900 dark:text-indigo-300">{{ $evento->nombre }}</h4>
                                        <p class="text-xs text-gray-600 dark:text-gray-400 mt-1 line-clamp-2">{{ $evento->descripcion }}</p>
                    ...
                    <div class="mt-6 pt-4 border-t dark:border-gray-700 text-center">
                        <a href="{{ route('admin.eventos.index') }}" class="text-sm text-indigo-600 dark:text-indigo-400 hover:underline">Ver Calendario Completo →</a>
                    </div>
                </div>
